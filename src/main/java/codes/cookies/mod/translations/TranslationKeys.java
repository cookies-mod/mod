...
public interface TranslationKeys {
	...
	String CONFIG_MINING_SHAFT_ANNOUNCE = CONFIG_MINING_SHAFT + ".announce";
	...
	String CONFIG_DUNGEON_ANNOUNCE_LEAPS = CONFIG_DUNGEON + ".announce_leaps";
	String CONFIG_DUNGEON_ANNOUNCE_LEAP_COORDS = CONFIG_DUNGEON + ".announce_leap_coords";
	...
	String CONFIG_DUNGEON_TERMINAL_MELODY = CONFIG_DUNGEON_TERMINAL + ".melody";
	String CONFIG_DUNGEON_TERMINAL_MELODY_NOTIFIER = CONFIG_DUNGEON_TERMINAL + ".melody_notifier";
	...
	String CONFIG_DUNGEON_PARTY_CHAT_COMMANDS = CONFIG_DUNGEON + ".party_chat_commands";
	String CONFIG_DUNGEON_PARTY_CHAT_COMMANDS_PT_ME = CONFIG_DUNGEON_PARTY_CHAT_COMMANDS + ".pt_me";
	String CONFIG_DUNGEON_PARTY_CHAT_COMMANDS_WARP = CONFIG_DUNGEON_PARTY_CHAT_COMMANDS + ".warp";
	...
	String CONFIG_DUNGEON_PARTY_CHAT_COMMANDS_DOWN_TIME_PARTY_MESSAGE = CONFIG_DUNGEON_PARTY_CHAT_COMMANDS_DOWN_TIME + ".party_message";
