...
public class ClientPlayNetworkHandlerMixin {
    ...
    /**
     * Wraps a logger invocation that is called multiple times per minute/second while playing on hypixel, to prevent spam in the console this invocation is cancelled.
     *
