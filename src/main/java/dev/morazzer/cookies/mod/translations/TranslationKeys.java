...
public interface TranslationKeys {
	...
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_1 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".1";
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_2 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".2";
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_3 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".3";
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_4 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".4";
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_5 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".5";
	String CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_6 = CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS + ".6";
	String[] CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_LORE = {
			CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_1,
			CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_2,
			CONFIG_DUNGEON_PUZZLE_WATER_BOARD_CREDITS_3,
